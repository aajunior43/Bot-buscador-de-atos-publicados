...
def mock_settings(tmp_path):
    ...
    object.__setattr__(settings, "quality_gap_detect", True)
    object.__setattr__(settings, "quality_gap_autoreprocess", False)
    object.__setattr__(settings, "quality_gap_mode", "reprocess")
    object.__setattr__(settings, "quality_gap_min_hits", 3)
    object.__setattr__(settings, "quality_gap_max_pubs", 1)
    object.__setattr__(settings, "quality_reprocess_preserve_feedback", True)
    object.__setattr__(settings, "agente_max_gap_por_ciclo", 1)
    object.__setattr__(settings, "quality_digest_diario", True)
    object.__setattr__(settings, "quality_webhook_digest", False)
    object.__setattr__(settings, "quality_webhook_enrich", True)
